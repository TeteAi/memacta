      ...
      {result && (
        <div data-testid="tool-result" className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {/* Download — smartDownload watermarks for free users on
                images; paid users always get raw; video is always raw
                until the server-side video watermark pipeline lands. */}
            {(result.startsWith("http") || result.startsWith("/")) && (
              <button
                type="button"
                onClick={() =>
                  smartDownload(result, tool.mediaOut, planId, {
